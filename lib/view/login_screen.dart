...
import 'package:supermercado/view/cadastro_screen.dart';
import 'package:supermercado/view/home_admin_screen.dart';
  ...
  Future<void> entrar() async {
    ...
    if(erroNome==null && erroCPF==null) {
      ...
      if(resultado!=null) {
        ...
        context.read<UsuarioController>().registrarUsuario(resultado);
